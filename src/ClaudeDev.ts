...
import { TaskManager } from "./ClaudeDev/TaskManager"
...
export class ClaudeDev {
	...
	constructor(
        ...
        this.taskManager = new TaskManager(provider, historyItem, task, images);
		...
		this.taskManager.initializeTask()
	...
	private async ensureTaskDirectoryExists(): Promise<string> {
		...
		const taskDir = path.join(globalStoragePath, "tasks", this.taskManager.getTaskId())
